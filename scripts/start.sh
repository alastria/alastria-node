...
if [ "$NODE_TYPE" == "bootnode" ]; then
   GLOBAL_ARGS="--networkid $NETID --identity $IDENTITY --permissioned admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --port 21000 --istanbul.requesttimeout 10000  --ethstats $IDENTITY:bb98a0b6442386d0cdf8a31b267892c1@netstats.telsius.alastria.io:80 --verbosity 3 --vmdebug --emitcheckpoints --targetgaslimit 18446744073709551615 --syncmode light --vmodule consensus/istanbul/core/core.go=5 --nodiscover "
 else
