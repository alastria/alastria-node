...
'$5~/enode/ { \
     ...
     if (arr[1] != "")  { \
          ...
          system("curl -ss -k -X DELETE --cert ~/certs/monitor-client.crt  --key ~/certs/monitor-client.key --cacert ~/certs/alastria-ca.crt -m 3 -H \"accept: application/json\" https://"arr[1]":8443/v1/node/transactions"); \
